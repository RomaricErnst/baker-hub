...
const ING: Record<string, Ingredient> = {
  ...
  sanMarzano: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '3–4 tbsp · thin layer, not a pool', noteFR: '3–4 c.à.s. · couche fine, pas trop' },
  ...
  marinaraSauce: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '3–4 tbsp · spread to 1cm from edge', noteFR: '3–4 c.à.s. · étaler à 1cm du bord' },
    qtyMultiplierByStyle: { roman: 1.3, pan: 1.4 },
    bakeOrderByStyle: { pan: 'after' },
    goodEnough: {
  ...
  olioBase: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 30, unit: 'ml', noteEN: '2–3 tbsp olive oil · brush evenly', noteFR: '2–3 c.à.s. huile d\'olive · badigeonner' },
  ...
  fiordilatte: {
    ...
    qtyPerPizza: { amount: 100, unit: 'g', noteEN: '5mm slices or tear — drained', noteFR: 'tranches 5mm ou déchirer — bien égoutté' },
  ...
  cream35: {
    ...
    qtyPerPizza: { amount: 80, unit: 'ml', noteEN: '5 tbsp · should just coat the base', noteFR: '5 c.à.s. · doit juste napper la base' },
    hardToFind: true,
    localSwap: {
      singapore: {
  ...
  cremeFraiche: {
    ...
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: '3 tbsp · thin coat', noteFR: '3 c.à.s. · couche fine' },
    qtyMultiplierByStyle: { roman: 1.3, pan: 1.4 },
    localSwap: {
      singapore: {
  ...
  raclette: {
    ...
    qtyPerPizza: { amount: 100, unit: 'g', noteEN: '4–5 slices', noteFR: '4–5 tranches' },
    hardToFind: true,
  ...
  smokedLardons: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: 'a small handful', noteFR: 'une petite poignée' },
  ...
  ham: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '3–4 slices · torn', noteFR: '3–4 tranches · déchirées' },
    goodEnough: {
  ...
  smSalmon: {
    ...
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: '3–4 slices', noteFR: '3–4 tranches' },
    goodEnough: {
  ...
  anchovies: {
    ...
    qtyPerPizza: { amount: 25, unit: 'g', noteEN: '5–6 fillets', noteFR: '5–6 filets' },
  ...
  thinPotato: {
    ...
    prepNoteByStyle: {
      roman: { en: 'For Pizza Romana: slice paper-thin (2mm) and pre-roast 10 min at 200°C before topping — the thin crispy base cannot handle raw potato moisture.', fr: 'Pour la Pizza Romana : trancher très finement (2mm) et pré-rôtir 10 min à 200°C avant de garnir — la base fine et croustillante ne supporte pas l\'humidité de la pomme de terre crue.', timing: 10 },
    },
  ...
  blackOlives: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 30, unit: 'g', noteEN: '8–10 olives', noteFR: '8–10 olives' },
  },
  ...
  redOnion: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 50, unit: 'g', noteEN: '½ onion · sliced thin', noteFR: '½ oignon · tranché fin' },
  },
  ...
  sweetcorn: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 50, unit: 'g', noteEN: 'a small handful', noteFR: 'une petite poignée' },
  },
  ...
  courgette: {
    ...
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: '½ courgette · sliced', noteFR: '½ courgette · tranchée' },
  },
  ...
  roastedPepper: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: '1 pepper · strips', noteFR: '1 poivron · en lanières' },
  },
  ...
  taleggio: {
    ...
    qtyPerPizza: { amount: 30, unit: 'g', noteEN: '2 thin slices · remove rind', noteFR: '2 tranches fines · enlever la croûte' },
    qtyMultiplierByStyle: { roman: 1.2, pan: 1.3 },
    hardToFind: true,
  ...
  parmigiano: {
    ...
    qtyPerPizza: { amount: 30, unit: 'g', noteEN: 'a small handful · grated', noteFR: 'une petite poignée · râpé' },
    qtyMultiplierByStyle: { roman: 1.2, pan: 1.3 },
  ...
  brie: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '4–5 slices · remove rind', noteFR: '4–5 tranches · enlever la croûte' },
    goodEnough: {
  ...
  ricotta: {
    ...
    qtyPerPizza: { amount: 100, unit: 'g', noteEN: '4 spoonfuls · dollop, not spread', noteFR: '4 cuillerées · en pointes, pas étalé' },
    qtyMultiplierByStyle: { roman: 1.2, pan: 1.3 },
    compromise: {
  ...
  walnuts: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 30, unit: 'g', noteEN: 'a small handful', noteFR: 'une petite poignée' },
  ...
  rocket: {
    ...
    qtyPerPizza: { amount: 20, unit: 'g', noteEN: 'a small handful', noteFR: 'une petite poignée' },
  ...
  evoOil: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 1, unit: 'drizzle' },
  },
  ...
  parmigianoShavings: {
    ...
    qtyPerPizza: { amount: 20, unit: 'g', noteEN: '5–6 shavings', noteFR: '5–6 copeaux' },
  },
  ...
  bbqSauce: {
    ...
    isCommonPantry: true,
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: '2–3 tbsp · spread to 1cm from edge', noteFR: '2–3 c.à.s. · étaler à 1cm du bord' },
  },
  ...
  pesto: {
    ...
    qtyPerPizza: { amount: 40, unit: 'g', noteEN: '1–2 tbsp · spread thin', noteFR: '1–2 c.à.s. · étaler finement' },
  ...
  strawberries: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '5–6 strawberries · sliced', noteFR: '5–6 fraises · tranchées' },
  },
  ...
  almondFlakes: {
    ...
    qtyPerPizza: { amount: 20, unit: 'g', noteEN: 'a small handful · toasted', noteFR: 'une petite poignée · grillées' },
  },
  ...
  asparagus: {
    ...
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: '3–4 spears', noteFR: '3–4 pointes' },
  },

  cornichons: {
    id: 'cornichons', category: 'veg', bakeOrder: 'after',
    name: { en: 'Cornichons', fr: 'Cornichons' },
    qtyPerPizza: { amount: 25, unit: 'g', noteEN: '4–5, sliced lengthwise', noteFR: '4–5, tranchés en longueur' },
  ...
  emmental: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: 'a good handful · grated', noteFR: 'une bonne poignée · râpé' },
  ...
  camembert: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '4–5 slices', noteFR: '4–5 tranches' },
  ...
  reblochon: {
    ...
    qtyPerPizza: { amount: 100, unit: 'g', noteEN: '5–6 slices', noteFR: '5–6 tranches' },
    hardToFind: true,
  ...
  chorizo: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '10–12 slices', noteFR: '10–12 tranches' },
  ...
  mixedPeppers: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '1 pepper · strips', noteFR: '1 poivron · en lanières' },
  ...
  guanciale: {
    ...
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: '6–8 thin slices', noteFR: '6–8 tranches fines' },
    hardToFind: true,
  ...
  friarielli: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: 'a small handful · pre-cooked', noteFR: 'une petite poignée · précuit' },
    hardToFind: true,
  ...
  stracciatella: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '3–4 spoonfuls', noteFR: '3–4 cuillerées' },
    qtyMultiplierByStyle: { roman: 1.2 },
    hardToFind: true,
  ...
  pistachiosPesto: {
    ...
    qtyPerPizza: { amount: 40, unit: 'g', noteEN: '2 tbsp', noteFR: '2 c.à.s.' },
  ...
  brickCheese: {
    ...
    qtyPerPizza: { amount: 150, unit: 'g', noteEN: 'grate generously', noteFR: 'râper généreusement' },
  ...
  labneh: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '3–4 dollops', noteFR: '3–4 cuillerées' },
  ...
  sobrasada: {
    ...
    qtyPerPizza: { amount: 50, unit: 'g', noteEN: 'spread or small dollops', noteFR: 'étaler ou déposer en pointes' },
    hardToFind: true,
  ...
  stracchino: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '4 dollops', noteFR: '4 cuillerées' },
    hardToFind: true,
  ...
  octopus: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: '4–5 pieces', noteFR: '4–5 morceaux' },
    hardToFind: false,
  ...
  kimchi: {
    ...
    qtyPerPizza: { amount: 60, unit: 'g', noteEN: 'a small handful · drained', noteFR: 'une petite poignée · égouttée' },
    localSwap: {
  ...
  duckConfit: {
    ...
    qtyPerPizza: { amount: 80, unit: 'g', noteEN: 'shred by hand', noteFR: 'effilocher à la main' },
    hardToFind: false,
...
export const PIZZAS: Pizza[] = [
...

  {
    ...
    ingredients: [ING.marinaraSauce, ING.fiordilatte, ING.mushrooms, { ...ING.ham, qtyPerPizza: { amount: 60, unit: 'g', noteEN: '2–3 slices · torn', noteFR: '2–3 tranches · déchirées' } }, ING.blackOlives, ING.artichoke, ING.evoOil],
...

  {
    ...
    category: 'modern', region: 'italian',
    base: 'tomato_raw', season: ['all'],
    occasion: ['impress'],
    dietary: ['no_nuts', 'no_fish'],
...

  {
    ...
    category: 'gourmet', region: 'italian',
    base: 'bianca_oil', season: ['autumn', 'winter'],
    occasion: ['impress'],
    dietary: ['no_fish'],
    budget: 3, complexity: 1, prepMinutes: 8, ovenTemp: 'mid',
...

  {
    ...
    category: 'french_regional', region: 'french',
    base: 'tomato_raw', season: ['all'],
    ...
    wine: ['lr', 'ro'],
    flavour: { richness: 2, boldness: 2, creative: 1, refined: 2 },
    ingredients: [ING.sanMarzano, ING.fiordilatte, ING.ham, ING.mushrooms, ING.blackOlives, ING.evoOil],
...

  {
    ...
    ingredients: [ING.sanMarzano, ING.fiordilatte, { ...ING.ham, qtyPerPizza: { amount: 60, unit: 'g', noteEN: '2–3 slices · torn', noteFR: '2–3 tranches · déchirées' } }, ING.spicySalami, ING.mixedPeppers, ING.blackOlives, ING.evoOil],
...

  {
    ...
    ingredients: [ING.sanMarzano, ING.fiordilatte, { ...ING.ham, qtyPerPizza: { amount: 60, unit: 'g', noteEN: '2–3 slices · torn', noteFR: '2–3 tranches · déchirées' } }, ING.mushrooms, ING.artichoke, ING.blackOlives, ING.evoOil],
...

  {
    ...
    category: 'classic_italian', region: 'italian',
    base: 'tomato_cooked', season: ['all'],
    occasion: ['classic', 'impress'],
...

  {
    ...
    category: 'seafood', region: 'italian',
    base: 'bianca_cream', season: ['all'],
    occasion: ['impress', 'quick'],
...

  {
    ...
    category: 'gourmet', region: 'fusion',
    base: 'bianca_cream', season: ['all'],
    occasion: ['impress'],
...

  {
    ...
    occasion: ['classic', 'impress'],
    dietary: ['no_nuts', 'no_fish'], budget: 1, complexity: 2, prepMinutes: 20, ovenTemp: 'mid',
    wine: ['cw', 'lr'],
...

  {
    ...
    category: 'seafood', region: 'fusion',
    base: 'bianca_cream', season: ['all'],
    occasion: ['impress', 'quick'],
...

  {
    ...
    base: 'bianca_oil', season: ['all'],
    occasion: ['impress'],
    dietary: ['pescatarian', 'no_nuts', 'no_pork'], budget: 3, complexity: 3, prepMinutes: 25, ovenTemp: 'high',
    wine: ['cw', 'sp'],
...

  {
    ...
    category: 'modern', region: 'middle_eastern',
    base: 'tomato_cooked',
    season: ['all'],
    occasion: ['impress', 'party'],
...

  {
    ...
    category: 'fusion', region: 'middle_eastern',
    base: 'tomato_cooked',
    season: ['all'],
    occasion: ['impress', 'quick'],
    dietary: ['veg', 'no_nuts', 'no_fish', 'no_pork', 'halal', 'kosher'],
...

  {
    ...
    ingredients: [ING.marinaraSauce, ING.mozzarellaLM, ING.ham, ING.pineapple],
  ...
  {
    id: 'laksa_prawn',
    name: { en: 'Laksa Prawn', fr: 'Laksa aux Crevettes' },
    story: {
      en: 'Singapore\'s most iconic noodle soup reinvented as a pizza — spicy coconut laksa base, fresh prawns, crispy tofu puffs.',
      fr: 'La soupe de nouilles la plus emblématique de Singapour réinventée en pizza — base laksa coco épicée, crevettes fraîches, tofu frit croustillant.',
    },
    category: 'fusion', region: 'asian',
    base: 'other',
    season: ['all'],
    occasion: ['party', 'impress'],
    dietary: ['no_nuts'],
    budget: 2, complexity: 3, prepMinutes: 25, ovenTemp: 'high',
    wine: ['rw'],
    flavour: { richness: 4, boldness: 4, creative: 5, refined: 2 },
    compatibleStyles: ['neapolitan', 'pan'],
    wineNote: { en: 'Off-dry Riesling · cuts through coconut richness', fr: 'Riesling demi-sec · coupe la richesse du coco' },
    ingredients: [
      {
        id: 'laksa_paste', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Laksa paste', fr: 'Pâte laksa' },
        prepNote: {
          en: 'Fry paste in oil 2–3 min until fragrant, add 3 tbsp coconut milk to loosen — spread thinly as pizza base.',
          fr: 'Faire revenir la pâte 2–3 min dans l\'huile jusqu\'à ce qu\'elle soit parfumée, ajouter 3 cas de lait de coco pour détendre — étaler finement comme base de pizza.',
          timing: 5,
        },
        qtyPerPizza: { amount: 60, unit: 'g' },
        goodEnough: {
          name: { en: 'Prima Taste Laksa paste sachet', fr: 'Sachet Prima Taste Laksa' },
          note: { en: 'The gold standard — used in most Singapore hawker stalls', fr: 'La référence — utilisé dans la plupart des hawker stalls de Singapour' },
        },
        localSwap: {
          singapore: {
            name: { en: 'Prima Taste or Kara brand laksa paste', fr: 'Pâte laksa Prima Taste ou Kara' },
            brandExamples: { singapore: ['Prima Taste Laksa — all supermarkets', 'Kara Laksa paste — FairPrice'] },
          },
        },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant', 'Sheng Siong'], note: 'Prima Taste laksa paste in every supermarket — cooking section' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Ace Mart'], note: 'Asian supermarkets — look for Prima Taste or Dollee brand' },
          uk: { shops: ['Wing Yip', 'SeeWoo', 'Tesco Asian range', 'Waitrose World Foods'], online: ['Amazon UK'], note: 'Prima Taste widely available in Asian supermarkets' },
          us: { shops: ['99 Ranch Market', 'H Mart', 'Hong Kong Supermarket', 'Seafood City'], online: ['Amazon', 'Weee!'], note: 'Prima Taste in Asian grocery chains nationwide' },
          australia: { shops: ['Asian grocery stores', 'Woolworths International aisle', 'Coles'], note: 'Prima Taste available in major supermarkets and Asian grocers' },
        },
      },
      {
        id: 'coconut_milk', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Coconut milk (full fat)', fr: 'Lait de coco (entier)' },
        prepNote: {
          en: 'Mix 3 tbsp into laksa paste to make the base — must be full fat or sauce splits in the oven.',
          fr: 'Mélanger 3 cas avec la pâte laksa pour faire la base — doit être entier sinon la sauce se sépare au four.',
        },
        qtyPerPizza: { amount: 45, unit: 'ml' },
        goodEnough: { name: { en: 'Kara or Aroy-D full fat coconut milk', fr: 'Lait de coco entier Kara ou Aroy-D' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant'], note: 'Kara brand widely available — look for full fat, not light' },
          france: { shops: ['Carrefour', 'Monoprix', 'Paris Store'], note: 'Aroy-D in Asian supermarkets; Kara in most large supermarkets' },
          uk: { shops: ['Tesco', 'Sainsbury\'s', 'Waitrose', 'Wing Yip'] },
          us: { shops: ['Whole Foods', 'Trader Joe\'s', '99 Ranch Market'], note: 'Chaokoh or Aroy-D in any Asian grocery' },
          australia: { shops: ['Coles', 'Woolworths', 'Asian grocery stores'] },
        },
      },
      {
        id: 'prawns_fresh', category: 'seafood', bakeOrder: 'before',
        name: { en: 'Fresh prawns (shell-off)', fr: 'Crevettes fraîches (décortiquées)' },
        prepNote: {
          en: 'Devein and pat dry. Marinate 5 min in fish sauce + white pepper. Place raw on pizza — they cook perfectly in the oven.',
          fr: 'Déveiné et bien séché. Mariner 5 min dans sauce poisson + poivre blanc. Placer crus sur la pizza — ils cuisent parfaitement au four.',
          timing: 5,
        },
        qtyPerPizza: { amount: 120, unit: 'g', noteEN: '5–6 medium prawns', noteFR: '5–6 crevettes moyennes' },
        goodEnough: { name: { en: 'Frozen tiger prawns, thawed and patted dry', fr: 'Crevettes tigre surgelées, décongelées et séchées' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Sheng Siong', 'Wet market', 'Cold Storage'], note: 'Fresh tiger prawns at wet market — best quality and price' },
          france: { shops: ['Poissonnerie', 'Carrefour', 'Grand Frais', 'Picard (frozen)'], note: 'Crevettes roses fraîches or frozen gambas' },
          uk: { shops: ['Tesco', 'Waitrose', 'fishmonger'], note: 'King prawns in most supermarkets' },
          us: { shops: ['Whole Foods', '99 Ranch Market', 'H Mart', 'Seafood counter'], note: 'Gulf shrimp or tiger prawns' },
          australia: { shops: ['Coles', 'Woolworths', 'fishmonger', 'Asian grocery'], note: 'Queensland tiger prawns — fresh or frozen' },
        },
      },
      {
        id: 'tofu_puffs', category: 'veg', bakeOrder: 'before',
        name: { en: 'Tofu puffs (tau pok)', fr: 'Tofu frit (tau pok)' },
        prepNote: {
          en: 'Halve and place cut-side up so they crisp in the oven. No pre-cooking needed.',
          fr: 'Couper en deux et placer côté coupé vers le haut pour qu\'ils croustillent au four. Pas de précuisson nécessaire.',
        },
        qtyPerPizza: { amount: 60, unit: 'g' },
        hardToFind: true,
        goodEnough: {
          name: { en: 'Firm tofu, cubed and pan-fried until golden', fr: 'Tofu ferme, coupé en dés et poêlé jusqu\'à dorure' },
          note: { en: 'Different texture but similar flavour absorption', fr: 'Texture différente mais absorption de saveur similaire' },
        },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Sheng Siong', 'Wet market tofu stalls'], note: 'Fresh tau pok at wet market tofu stalls — far superior to packaged' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Ace Mart', 'Naturalia'], note: 'Asian supermarkets — réfrigéré section' },
          uk: { shops: ['Wing Yip', 'SeeWoo', 'Oriental City'], note: 'Refrigerated section in Chinese supermarkets' },
          us: { shops: ['99 Ranch Market', 'H Mart', 'Mitsuwa', 'Chinese grocery stores'], note: 'Refrigerated tofu section' },
          australia: { shops: ['Asian grocery stores', 'Harris Farm', 'Chinese supermarkets'] },
        },
      },
      {
        id: 'bean_sprouts', category: 'veg', bakeOrder: 'after',
        name: { en: 'Bean sprouts', fr: 'Germes de soja' },
        prepNote: {
          en: 'Add raw after baking — oven wilts them completely. They provide crunch and freshness.',
          fr: 'Ajouter crus après cuisson — le four les flétrit complètement. Ils apportent croquant et fraîcheur.',
        },
        qtyPerPizza: { amount: 40, unit: 'g' },
        goodEnough: { name: { en: 'Thinly sliced cucumber ribbons', fr: 'Rubans de concombre en fines tranches' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Sheng Siong', 'Wet market'], note: 'Universally available — any supermarket' },
          france: { shops: ['Asian supermarkets', 'Carrefour Bio'], note: 'Pousses de soja — Asian aisle of large supermarkets' },
          uk: { shops: ['Tesco', 'Sainsbury\'s', 'Wing Yip'] },
          us: { shops: ['Any supermarket'], note: 'Bean sprouts in produce section everywhere' },
          australia: { shops: ['Coles', 'Woolworths', 'Asian grocers'] },
        },
      },
      {
        id: 'sambal', category: 'finish', bakeOrder: 'after',
        name: { en: 'Sambal chilli', fr: 'Sambal piment' },
        prepNote: {
          en: 'Drizzle after baking. Adds essential heat and fermented depth. Adjust to taste.',
          fr: 'Arroser après cuisson. Apporte la chaleur essentielle et la profondeur fermentée. Ajuster selon le goût.',
        },
        qtyPerPizza: { amount: 15, unit: 'g' },
        goodEnough: { name: { en: 'Sriracha or any chilli paste', fr: 'Sriracha ou toute pâte de piment' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant'], note: 'Tean\'s or Lingham\'s sambal in every supermarket' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Carrefour World Foods'], note: 'Sambal oelek in Asian supermarkets' },
          uk: { shops: ['Tesco', 'Wing Yip', 'Waitrose World Foods'] },
          us: { shops: ['Whole Foods', '99 Ranch Market', 'H Mart'], note: 'Huy Fong sambal oelek in every Asian section' },
          australia: { shops: ['Coles', 'Woolworths', 'Asian grocery'] },
        },
      },
    ],
  },
  ...
  {
    id: 'satay_chicken',
    name: { en: 'Satay Chicken', fr: 'Poulet Satay' },
    story: {
      en: 'Southeast Asia\'s favourite street food on a pizza — peanut satay base, grilled chicken, cucumber, sweet soy.',
      fr: 'Le street food préféré d\'Asie du Sud-Est en pizza — base satay cacahuète, poulet grillé, concombre, sauce soja sucrée.',
    },
    category: 'fusion', region: 'asian',
    base: 'other',
    season: ['all'],
    occasion: ['party', 'kids'],
    dietary: [],
    budget: 2, complexity: 2, prepMinutes: 20, ovenTemp: 'high',
    wine: ['rw'],
    flavour: { richness: 3, boldness: 3, creative: 4, refined: 2 },
    compatibleStyles: ['neapolitan', 'pan'],
    wineNote: { en: 'Gewürztraminer · aromatic white pairs with peanut and spice', fr: 'Gewürztraminer · blanc aromatique qui s\'associe bien aux cacahuètes et aux épices' },
    ingredients: [
      {
        id: 'satay_sauce', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Satay peanut sauce', fr: 'Sauce satay cacahuète' },
        prepNote: {
          en: 'Use ready-made satay sauce thinned with 1 tbsp water — must be spreadable. Or make: blend roasted peanuts, coconut milk, lemongrass, galangal, turmeric, chilli.',
          fr: 'Utiliser une sauce satay prête à l\'emploi allongée d\'1 cas d\'eau — doit être tartinable. Ou faire maison : mixer cacahuètes grillées, lait de coco, citronnelle, galanga, curcuma, piment.',
          timing: 5,
        },
        qtyPerPizza: { amount: 80, unit: 'g' },
        goodEnough: { name: { en: 'Any jarred satay or peanut sauce', fr: 'Toute sauce satay ou cacahuète en pot' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant'], note: 'Prima Taste or Tean\'s satay sauce in cooking aisle' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Carrefour'], note: 'Sauce satay in Asian supermarkets — also Suzi Wan brand in large supermarkets' },
          uk: { shops: ['Tesco', 'Waitrose', 'Wing Yip'], note: 'Blue Dragon or Bart satay sauce widely available' },
          us: { shops: ['Whole Foods', 'Trader Joe\'s', 'H Mart'], note: 'Thai Kitchen or Roland brand in most supermarkets' },
          australia: { shops: ['Coles', 'Woolworths', 'Asian grocers'], note: 'Ayam brand satay sauce in most supermarkets' },
        },
      },
      {
        id: 'chicken_thigh_grilled', category: 'meat', bakeOrder: 'before',
        name: { en: 'Grilled chicken thigh (satay-marinated)', fr: 'Cuisse de poulet grillée (marinée satay)' },
        prepNote: {
          en: 'Marinate 30 min in turmeric, lemongrass, sugar, soy. Grill or pan-fry until charred. Slice thinly.',
          fr: 'Mariner 30 min dans curcuma, citronnelle, sucre, soja. Griller ou poêler jusqu\'à légère carbonisation. Trancher finement.',
          timing: 30,
        },
        qtyPerPizza: { amount: 120, unit: 'g' },
        goodEnough: { name: { en: 'Rotisserie chicken, shredded', fr: 'Poulet rôti du commerce, effiloché' } },
        whereToFind: {
          singapore: { shops: ['Any supermarket or wet market'], note: 'Fresh chicken thigh at wet market — best value' },
          france: { shops: ['Boucherie', 'Carrefour', 'Monoprix'], note: 'Hauts de cuisse de poulet — any butcher or supermarket' },
          uk: { shops: ['Any supermarket'], note: 'Chicken thighs in any supermarket' },
          us: { shops: ['Any supermarket'], note: 'Boneless skinless chicken thighs — widely available' },
          australia: { shops: ['Coles', 'Woolworths', 'butcher'] },
        },
      },
      {
        id: 'cucumber_fresh', category: 'finish', bakeOrder: 'after',
        name: { en: 'Fresh cucumber (sliced)', fr: 'Concombre frais (tranché)' },
        prepNote: {
          en: 'Add after baking — cool crunch against the warm pizza is essential to the satay experience.',
          fr: 'Ajouter après cuisson — le croquant frais contre la pizza chaude est essentiel à l\'expérience satay.',
        },
        qtyPerPizza: { amount: 50, unit: 'g' },
        isCommonPantry: true,
      },
      {
        id: 'red_onion_raw', category: 'finish', bakeOrder: 'after',
        name: { en: 'Red onion (thinly sliced)', fr: 'Oignon rouge (finement tranché)' },
        prepNote: { en: 'Add raw after baking for bite and colour.', fr: 'Ajouter cru après cuisson pour du croquant et de la couleur.' },
        qtyPerPizza: { amount: 30, unit: 'g', noteEN: 'a few rings', noteFR: 'quelques rondelles' },
        isCommonPantry: true,
      },
      {
        id: 'crushed_peanuts', category: 'finish', bakeOrder: 'after',
        name: { en: 'Crushed roasted peanuts', fr: 'Cacahuètes grillées concassées' },
        prepNote: { en: 'Scatter generously after baking — essential texture.', fr: 'Parsemer généreusement après cuisson — texture essentielle.' },
        qtyPerPizza: { amount: 25, unit: 'g' },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Sheng Siong', 'Phoon Huat'], note: 'Roasted peanuts in snack or baking aisle' },
          france: { shops: ['Carrefour', 'Monoprix', 'Casino'], note: 'Cacahuètes grillées sans sel en snack aisle' },
          uk: { shops: ['Any supermarket'], note: 'Dry roasted peanuts — snack aisle' },
          us: { shops: ['Any supermarket'], note: 'Dry roasted peanuts or Spanish peanuts' },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
      },
    ],
  },
  ...
  {
    id: 'rendang_beef',
    name: { en: 'Rendang Beef', fr: 'Bœuf Rendang' },
    story: {
      en: 'Indonesia\'s most celebrated slow-cooked beef — dry coconut rendang on a crispy pizza base, fresh herbs.',
      fr: 'Le bœuf braisé le plus célèbre d\'Indonésie — rendang sec à la noix de coco sur une base de pizza croustillante, herbes fraîches.',
    },
    category: 'fusion', region: 'asian',
    base: 'other',
    season: ['all'],
    occasion: ['impress', 'party'],
    dietary: ['no_fish'],
    budget: 3, complexity: 3, prepMinutes: 30, ovenTemp: 'high',
    wine: ['rw'],
    flavour: { richness: 5, boldness: 5, creative: 4, refined: 3 },
    compatibleStyles: ['neapolitan', 'pan'],
    wineNote: { en: 'GSM blend · earthy red matches the spice depth', fr: 'Assemblage GSM · rouge terreux s\'accorde avec la profondeur épicée' },
    ingredients: [
      {
        id: 'rendang_paste', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Rendang paste', fr: 'Pâte rendang' },
        prepNote: {
          en: 'Fry paste in oil 3 min until fragrant. Add 60ml coconut milk and reduce to thick paste before spreading.',
          fr: 'Faire revenir la pâte dans l\'huile 3 min jusqu\'à ce qu\'elle soit parfumée. Ajouter 60ml lait de coco et réduire en pâte épaisse avant d\'étaler.',
          timing: 10,
        },
        qtyPerPizza: { amount: 60, unit: 'g' },
        hardToFind: true,
        goodEnough: {
          name: { en: 'Kari House or Brahim\'s rendang paste', fr: 'Pâte rendang Kari House ou Brahim\'s' },
          note: { en: 'Ready-made paste — excellent quality available in Asian stores', fr: 'Pâte prête à l\'emploi — excellente qualité disponible en épiceries asiatiques' },
        },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Sheng Siong', 'Mustafa Centre'], note: 'Brahim\'s or Prima Taste rendang paste — cooking aisle' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Ace Mart'], note: 'Indonesian/Malaysian section in Asian supermarkets — Conimex brand sometimes available' },
          uk: { shops: ['Wing Yip', 'SeeWoo', 'Oriental City'], online: ['Amazon UK'], note: 'Asian supermarkets — look for Malaysian or Indonesian brands' },
          us: { shops: ['99 Ranch Market', 'H Mart', 'Seafood City', 'Indonesian grocery'], online: ['Amazon', 'Weee!'], note: 'Conimex or Brahim\'s in Asian grocery chains' },
          australia: { shops: ['Asian grocery stores', 'Woolworths International'], note: 'Brahim\'s rendang paste in Malaysian/Indonesian grocery stores — Sydney/Melbourne have many' },
        },
      },
      {
        id: 'beef_short_rib_cooked', category: 'meat', bakeOrder: 'before',
        name: { en: 'Slow-cooked beef (rendang style)', fr: 'Bœuf braisé lentement (style rendang)' },
        prepNote: {
          en: 'Simmer beef chuck or short rib in rendang paste + coconut milk 2h until dry and caramelised. Shred. Or use leftover rendang.',
          fr: 'Mijoter bœuf paleron ou plat de côtes dans pâte rendang + lait de coco 2h jusqu\'à ce que sec et caramélisé. Effilocher. Ou utiliser du rendang restant.',
          timing: 120,
        },
        qtyPerPizza: { amount: 100, unit: 'g' },
        goodEnough: { name: { en: 'Ready-made beef rendang from Asian deli or hawker stall', fr: 'Rendang de bœuf prêt à l\'emploi d\'une épicerie asiatique ou d\'un hawker stall' } },
        whereToFind: {
          singapore: { shops: ['Sheng Siong', 'FairPrice ready meals', 'Hawker stalls'], note: 'Buy ready-made rendang from any Malay hawker stall — faster and often better' },
          france: { shops: ['Asian supermarkets ready meals section'], note: 'Very limited ready-made — cook from paste is easiest route' },
          uk: { shops: ['Asian supermarkets', 'Waitrose ready meals'], note: 'Occasional ready-made — cooking from paste more reliable' },
          us: { shops: ['Indonesian/Malaysian restaurants (takeaway)', 'Asian grocery ready meals'], note: 'Buy from Indonesian restaurant if available locally' },
          australia: { shops: ['Malaysian restaurants', 'Asian grocery ready meals'], note: 'Large Malaysian community in Sydney/Melbourne — buy from restaurant' },
        },
      },
      {
        id: 'kaffir_lime_leaves', category: 'finish', bakeOrder: 'after',
        name: { en: 'Kaffir lime leaves (chiffonade)', fr: 'Feuilles de combava (chiffonade)' },
        prepNote: {
          en: 'Remove central stem, roll tightly, slice ultra-thin. Scatter raw after baking — aromatic finish.',
          fr: 'Retirer la nervure centrale, rouler serré, trancher très finement. Parsemer crus après cuisson — finition aromatique.',
        },
        qtyPerPizza: { amount: 4, unit: 'leaves' },
        hardToFind: true,
        goodEnough: { name: { en: 'Fresh lime zest + fresh coriander', fr: 'Zeste de citron vert frais + coriandre fraîche' } },
        whereToFind: {
          singapore: { shops: ['Wet market', 'Sheng Siong', 'FairPrice'], note: 'Fresh kaffir lime leaves at any wet market — extremely cheap' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Ace Mart'], note: 'Feuilles de combava fraîches or frozen in Asian supermarkets' },
          uk: { shops: ['Wing Yip', 'SeeWoo', 'Oriental City', 'Thai grocery'], note: 'Fresh or frozen in Asian supermarkets — also sometimes Sainsbury\'s' },
          us: { shops: ['99 Ranch Market', 'H Mart', 'Thai grocery stores'], note: 'Fresh in Asian supermarkets — frozen widely available' },
          australia: { shops: ['Asian grocery', 'Harris Farm', 'some Coles'], note: 'Fresh kaffir lime leaves in Asian grocers and some supermarkets' },
        },
      },
    ],
  },
  ...
  {
    id: 'tom_yam_prawn',
    name: { en: 'Tom Yam Prawn', fr: 'Crevettes Tom Yam' },
    story: {
      en: 'Thailand\'s fiery lemongrass and lime broth reimagined as a pizza — tom yam cream base, fresh prawns, mushrooms.',
      fr: 'Le bouillon thaïlandais citronnelle-citron vert réinterprété en pizza — base crème tom yam, crevettes fraîches, champignons.',
    },
    category: 'fusion', region: 'asian',
    base: 'other',
    season: ['all'],
    occasion: ['impress', 'spicy'],
    dietary: ['no_nuts'],
    budget: 2, complexity: 3, prepMinutes: 20, ovenTemp: 'high',
    wine: ['rw'],
    flavour: { richness: 3, boldness: 5, creative: 5, refined: 2 },
    compatibleStyles: ['neapolitan', 'pizza_romana'],
    wineNote: { en: 'Dry Riesling · handles the sour-spicy profile', fr: 'Riesling sec · supporte le profil aigre-épicé' },
    ingredients: [
      {
        id: 'tom_yam_paste', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Tom yam paste', fr: 'Pâte tom yam' },
        prepNote: {
          en: 'Mix 2 tbsp paste with 3 tbsp cream cheese or crème fraîche — creates a creamy spiced base that holds in the oven.',
          fr: 'Mélanger 2 cas de pâte avec 3 cas de cream cheese ou crème fraîche — crée une base crémeuse épicée qui tient au four.',
          timing: 5,
        },
        qtyPerPizza: { amount: 40, unit: 'g' },
        goodEnough: { name: { en: 'Maeploy or Lobo tom yam paste', fr: 'Pâte tom yam Maeploy ou Lobo' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant'], note: 'Maeploy or Lobo brand — Thai section' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Ace Mart'], note: 'Section thaïlandaise en épicerie asiatique' },
          uk: { shops: ['Tesco', 'Waitrose World Foods', 'Wing Yip'], note: 'Blue Dragon or Maeploy — widely available' },
          us: { shops: ['99 Ranch Market', 'H Mart', 'Whole Foods'], note: 'Thai Kitchen or Maeploy in Asian section' },
          australia: { shops: ['Coles', 'Woolworths', 'Asian grocery'], note: 'Maeploy widely available' },
        },
      },
      {
        id: 'prawns_fresh', category: 'seafood', bakeOrder: 'before',
        name: { en: 'Fresh prawns (shell-off)', fr: 'Crevettes fraîches (décortiquées)' },
        prepNote: {
          en: 'Devein, pat dry, season with fish sauce. Place raw — cook perfectly in oven.',
          fr: 'Déveiné, sécher, assaisonner avec sauce poisson. Placer crus — cuisent parfaitement au four.',
          timing: 5,
        },
        qtyPerPizza: { amount: 120, unit: 'g', noteEN: '5–6 medium prawns', noteFR: '5–6 crevettes moyennes' },
        goodEnough: { name: { en: 'Frozen tiger prawns, thawed', fr: 'Crevettes tigre surgelées, décongelées' } },
        whereToFind: {
          singapore: { shops: ['Wet market', 'FairPrice', 'Sheng Siong'] },
          france: { shops: ['Poissonnerie', 'Grand Frais', 'Carrefour'] },
          uk: { shops: ['Tesco', 'Waitrose', 'fishmonger'] },
          us: { shops: ['Whole Foods', '99 Ranch Market', 'seafood counter'] },
          australia: { shops: ['Coles', 'Woolworths', 'fishmonger'] },
        },
      },
      {
        id: 'straw_mushrooms', category: 'veg', bakeOrder: 'before',
        name: { en: 'Straw mushrooms (or oyster mushrooms)', fr: 'Champignons de paille (ou champignons huître)' },
        prepNote: { en: 'Halve and scatter raw — they roast beautifully in the oven.', fr: 'Couper en deux et disperser crus — ils rôtissent bien au four.' },
        qtyPerPizza: { amount: 60, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Oyster mushrooms or button mushrooms', fr: 'Champignons huître ou champignons de Paris' } },
        whereToFind: {
          singapore: { shops: ['Wet market', 'Sheng Siong', 'FairPrice'], note: 'Fresh straw mushrooms at wet market — very common' },
          france: { shops: ['Paris Store', 'Tang Frères'], note: 'Champignons de paille en conserve en épicerie asiatique; champignons huître chez Grand Frais' },
          uk: { shops: ['Wing Yip', 'SeeWoo', 'Oriental City'], note: 'Fresh oyster mushrooms as substitute in most supermarkets' },
          us: { shops: ['99 Ranch Market', 'H Mart', 'Whole Foods'], note: 'Canned straw mushrooms or fresh oyster mushrooms' },
          australia: { shops: ['Asian grocery', 'Harris Farm'], note: 'Fresh oyster mushrooms widely available' },
        },
      },
      {
        id: 'lime_fresh', category: 'finish', bakeOrder: 'after',
        name: { en: 'Fresh lime (wedges)', fr: 'Citron vert frais (quartiers)' },
        prepNote: { en: 'Serve alongside — squeeze over at the table. Essential acid hit.', fr: 'Servir à côté — presser à table. Acidité essentielle.' },
        qtyPerPizza: { amount: 1, unit: 'pcs' },
        isCommonPantry: true,
      },
    ],
  ...
  {
    id: 'banh_mi_pizza',
    name: { en: 'Bánh Mì Pizza', fr: 'Pizza Bánh Mì' },
    story: {
      en: 'Vietnam\'s legendary sandwich deconstructed on a pizza — pâté base, char siu or grilled pork, pickled daikon, jalapeño, fresh herbs.',
      fr: 'Le légendaire sandwich vietnamien déconstruit en pizza — base de pâté, char siu ou porc grillé, daikon mariné, jalapeño, herbes fraîches.',
    },
    category: 'fusion', region: 'asian',
    base: 'other',
    season: ['all'],
    ...
    budget: 2, complexity: 3, prepMinutes: 25, ovenTemp: 'high',
    wine: ['rw', 'sp'],
    flavour: { richness: 3, boldness: 4, creative: 5, refined: 3 },
    compatibleStyles: ['neapolitan', 'pizza_romana', 'newyork'],
    wineNote: { en: 'Crémant d\'Alsace · bubbles cut through the richness', fr: 'Crémant d\'Alsace · les bulles coupent la richesse' },
    ingredients: [
      {
        id: 'chicken_liver_pate', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Chicken liver pâté', fr: 'Pâté de foie de volaille' },
        prepNote: {
          en: 'Spread thinly as base — acts as the fat and umami layer. Authentic bánh mì uses Vietnamese pâté (pork liver) but chicken liver pâté works perfectly.',
          fr: 'Étaler finement comme base — agit comme couche de gras et d\'umami. Le bánh mì authentique utilise du pâté vietnamien (foie de porc) mais le pâté de foie de volaille fonctionne parfaitement.',
        },
        qtyPerPizza: { amount: 60, unit: 'g' },
        goodEnough: { name: { en: 'Any smooth chicken liver pâté', fr: 'Tout pâté de foie de volaille lisse' } },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'Marketplace', 'FairPrice Finest'], note: 'Rougie or président brand — deli section. Vietnamese pâté at Vietnamese grocery stores in Golden Mile' },
          france: { shops: ['Any supermarket', 'charcutier'], note: 'Pâté de foie de volaille — charcuterie aisle in every French supermarket' },
          uk: { shops: ['Tesco', 'Waitrose', 'M&S', 'any deli'] },
          us: { shops: ['Whole Foods', 'Trader Joe\'s', 'French deli', 'Vietnamese grocery'], note: 'Trader Joe\'s chicken liver mousse is excellent and affordable' },
          australia: { shops: ['Coles', 'Woolworths', 'deli counter'], note: 'Chicken liver pâté in deli section' },
        },
      },
      {
        id: 'char_siu_pork', category: 'meat', bakeOrder: 'before',
        name: { en: 'Char siu pork (or grilled pork belly)', fr: 'Porc char siu (ou poitrine de porc grillée)' },
        prepNote: {
          en: 'Slice thinly. Place before baking — the caramelised char siu glaze intensifies in the oven.',
          fr: 'Trancher finement. Placer avant cuisson — le glaçage caramélisé char siu s\'intensifie au four.',
        },
        qtyPerPizza: { amount: 100, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Pork belly marinated in hoisin + honey + five spice, roasted', fr: 'Poitrine de porc marinée dans hoisin + miel + cinq épices, rôtie' } },
        whereToFind: {
          singapore: { shops: ['Chinese BBQ stalls (siu mei)', 'FairPrice ready meals'], note: 'Buy from any Chinese BBQ (siu mei) stall — best quality, costs $5–8' },
          france: { shops: ['Thanh Long', 'Paris Store', 'Chinese BBQ restaurants (takeaway)'], note: 'Chinese restaurants in Paris 13ème do char siu takeaway' },
          uk: { shops: ['Wing Yip', 'SeeWoo', 'Chinese BBQ shops in Chinatown'], note: 'London/Manchester Chinatown BBQ shops sell char siu by weight' },
          us: { shops: ['99 Ranch Market', 'Chinese BBQ restaurants', 'H Mart'], note: 'Chinese BBQ shops in any Chinatown — also pre-marinated at 99 Ranch' },
          australia: { shops: ['Chinese BBQ shops', 'Asian grocery ready meals'], note: 'BBQ pork shops in Sydney/Melbourne Chinatown' },
        },
      },
      {
        id: 'pickled_daikon_carrot', category: 'finish', bakeOrder: 'after',
        name: { en: 'Pickled daikon & carrot (đồ chua)', fr: 'Daikon et carotte marinés (đồ chua)' },
        prepNote: {
          en: 'Add after baking — never cook. Quick pickle: julienne daikon and carrot, soak 30 min in rice vinegar + sugar + salt.',
          fr: 'Ajouter après cuisson — ne jamais cuire. Marinade rapide : julienne de daikon et carotte, tremper 30 min dans vinaigre de riz + sucre + sel.',
          timing: 30,
        },
        qtyPerPizza: { amount: 60, unit: 'g' },
        goodEnough: { name: { en: 'Ready-made pickled vegetables from Asian deli', fr: 'Légumes marinés prêts à l\'emploi d\'une épicerie asiatique' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Sheng Siong', 'Vietnamese deli at Golden Mile'], note: 'Make at home (5 min) or buy ready-made at Vietnamese grocery' },
          france: { shops: ['Paris Store', 'Tang Frères'], note: 'Légumes marinés vietnamiens en épicerie asiatique du 13ème' },
          uk: { shops: ['Wing Yip', 'Vietnamese deli', 'SeeWoo'], note: 'Buy ready-made or make at home in 30 min' },
          us: { shops: ['99 Ranch Market', 'H Mart', 'Vietnamese grocery'], note: 'Ready-made đồ chua in Vietnamese grocery stores' },
          australia: { shops: ['Asian grocery', 'Vietnamese deli'], note: 'Vietnamese grocers in Cabramatta (Sydney) or Springvale (Melbourne)' },
        },
      },
      {
        id: 'fresh_coriander', category: 'finish', bakeOrder: 'after',
        name: { en: 'Fresh coriander', fr: 'Coriandre fraîche' },
        prepNote: { en: 'Scatter generously after baking — essential aromatic finish.', fr: 'Parsemer généreusement après cuisson — finition aromatique essentielle.' },
        qtyPerPizza: { amount: 10, unit: 'g' },
        goodEnough: { name: { en: 'Fresh mint or Thai basil if coriander unavailable', fr: 'Menthe fraîche ou basilic thaï si coriandre indisponible' } },
        whereToFind: {
          singapore: { shops: ['Any wet market', 'FairPrice', 'Sheng Siong'], note: 'Universally available and very cheap at wet markets' },
          france: { shops: ['Marché', 'Asian supermarket', 'Carrefour Bio'], note: 'Coriandre fraîche in Asian supermarkets or markets — scarcer in small supermarkets' },
          uk: { shops: ['Tesco', 'Sainsbury\'s', 'any supermarket'] },
          us: { shops: ['Any supermarket', 'Latin grocery', 'Asian grocery'] },
          australia: { shops: ['Coles', 'Woolworths', 'Asian grocery'] },
        },
      },
      {
        id: 'jalapeno_sliced', category: 'finish', bakeOrder: 'after',
        name: { en: 'Jalapeño (sliced)', fr: 'Jalapeño (tranché)' },
        prepNote: { en: 'Add fresh after baking for heat and crunch.', fr: 'Ajouter frais après cuisson pour le piquant et le croquant.' },
        qtyPerPizza: { amount: 20, unit: 'g' },
        goodEnough: { name: { en: 'Pickled jalapeño slices from jar', fr: 'Rondelles de jalapeño marinées en pot' } },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'Marketplace', 'Jason\'s'], note: 'Pickled jalapeño in jars — international section' },
          france: { shops: ['Monoprix', 'Carrefour', 'épicerie mexicaine'], note: 'Jalapeños en conserve dans la plupart des supermarchés' },
          uk: { shops: ['Tesco', 'Sainsbury\'s', 'Waitrose'] },
          us: { shops: ['Any supermarket'], note: 'Fresh or pickled jalapeño in every supermarket' },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
      },
    ],
  ...
  {
    id: 'peking_duck',
    name: { en: 'Peking Duck', fr: 'Canard Pékinois' },
    story: {
      en: 'One of China\'s most celebrated dishes on a pizza — hoisin base, crispy Peking duck, spring onion, cucumber.',
      fr: 'L\'un des plats les plus célèbres de Chine en pizza — base hoisin, canard pékinois croustillant, oignon de printemps, concombre.',
    },
    category: 'fusion', region: 'asian',
    base: 'other',
    season: ['all'],
    occasion: ['impress'],
    dietary: ['no_fish', 'no_nuts'],
    budget: 3, complexity: 3, prepMinutes: 15, ovenTemp: 'high',
    wine: ['rw', 'sp'],
    flavour: { richness: 4, boldness: 3, creative: 4, refined: 4 },
    compatibleStyles: ['neapolitan', 'pizza_romana', 'newyork'],
    wineNote: { en: 'Pinot Noir · classic pairing with duck', fr: 'Pinot Noir · accord classique avec le canard' },
    ingredients: [
      {
        id: 'hoisin_sauce', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Hoisin sauce', fr: 'Sauce hoisin' },
        prepNote: {
          en: 'Spread directly as base — do not thin or cook. A thin layer is enough; hoisin intensifies strongly in the oven.',
          fr: 'Étaler directement comme base — ne pas diluer ni cuire. Une fine couche suffit ; le hoisin s\'intensifie fortement au four.',
        },
        qtyPerPizza: { amount: 50, unit: 'g' },
        goodEnough: { name: { en: 'Lee Kum Kee or Kikkoman hoisin sauce', fr: 'Sauce hoisin Lee Kum Kee ou Kikkoman' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant'], note: 'Lee Kum Kee — every supermarket, Chinese cooking aisle' },
          france: { shops: ['Paris Store', 'Tang Frères', 'Carrefour World Foods'], note: 'Lee Kum Kee in Asian supermarkets and world foods aisle' },
          uk: { shops: ['Tesco', 'Waitrose', 'Wing Yip'], note: 'Lee Kum Kee or Blue Dragon — widely available' },
          us: { shops: ['Any supermarket', '99 Ranch Market'], note: 'Every supermarket carries hoisin sauce' },
          australia: { shops: ['Coles', 'Woolworths', 'Asian grocery'] },
        },
      },
      {
        id: 'peking_duck_meat', category: 'meat', bakeOrder: 'before',
        name: { en: 'Peking duck (shredded)', fr: 'Canard pékinois (effiloché)' },
        prepNote: {
          en: 'Buy whole Peking duck from Chinese BBQ shop and shred the breast meat. Place before baking — skin crisps further. Reserve the pancakes for another use.',
          fr: 'Acheter un canard pékinois entier dans une boutique de BBQ chinois et effilocher la viande de poitrine. Placer avant cuisson — la peau devient encore plus croustillante. Garder les crêpes pour un autre usage.',
        },
        qtyPerPizza: { amount: 100, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Confit duck leg, shredded + brushed with hoisin', fr: 'Cuisse de canard confite, effilochée + badigeonnée de hoisin' } },
        whereToFind: {
          singapore: { shops: ['Chinese BBQ stalls (siu mei)', 'Chinatown food centre'], note: 'Full Peking duck at any Chinese BBQ stall — order in advance if possible' },
          france: { shops: ['Chinatown restaurants (Paris 13ème)', 'Asian deli'], note: 'Buy from Chinese restaurants in Paris 13ème or use confit de canard from any supermarket' },
          uk: { shops: ['London/Manchester Chinatown BBQ shops', 'Wing Yip ready meals'], note: 'Chinese BBQ shops sell by portion. Or use M&S Peking duck ready meal.' },
          us: { shops: ['Chinese BBQ restaurants', '99 Ranch Market deli', 'Chinatown BBQ shops'], note: 'Any Chinatown BBQ shop — also available at 99 Ranch deli counter' },
          australia: { shops: ['Chinese BBQ shops in Chinatown', 'Asian grocery ready meals'], note: 'Sydney/Melbourne Chinatown have excellent BBQ shops' },
        },
      },
      {
        id: 'spring_onion', category: 'finish', bakeOrder: 'after',
        name: { en: 'Spring onion (sliced)', fr: 'Oignon de printemps (tranché)' },
        prepNote: { en: 'Scatter after baking — the crunch and freshness is essential.', fr: 'Parsemer après cuisson — le croquant et la fraîcheur sont essentiels.' },
        qtyPerPizza: { amount: 20, unit: 'g' },
        isCommonPantry: true,
      },
      {
        id: 'cucumber_fresh', category: 'finish', bakeOrder: 'after',
        name: { en: 'Cucumber (julienned)', fr: 'Concombre (en julienne)' },
        prepNote: { en: 'Add cold after baking — the cool crunch mirrors the Peking duck pancake experience.', fr: 'Ajouter froid après cuisson — le croquant frais reproduit l\'expérience de la crêpe de canard pékinois.' },
        qtyPerPizza: { amount: 50, unit: 'g' },
        isCommonPantry: true,
      },
    ],
  ...
  {
    id: 'cheeseburger_pizza',
    name: { en: 'Cheeseburger Pizza', fr: 'Pizza Cheeseburger' },
    story: {
      en: 'Two American classics collide — burger sauce base, seasoned beef, pickles, cheddar, mustard. Best on NY or pan.',
      fr: 'Deux classiques américains se rencontrent — base sauce burger, bœuf assaisonné, cornichons, cheddar, moutarde. Meilleur en NY ou pan.',
    },
    category: 'fusion', region: 'american',
    base: 'other',
    season: ['all'],
    ...
    budget: 2, complexity: 2, prepMinutes: 15, ovenTemp: 'high',
    wine: ['rw'],
    flavour: { richness: 4, boldness: 4, creative: 3, refined: 1 },
    compatibleStyles: ['newyork', 'pan'],
    wineNote: { en: 'Zinfandel · bold red for bold flavours', fr: 'Zinfandel · rouge puissant pour des saveurs puissantes' },
    ingredients: [
      {
        id: 'burger_sauce', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Burger sauce (secret sauce)', fr: 'Sauce burger (sauce secrète)' },
        prepNote: {
          en: 'Mix equal parts mayo + ketchup + American mustard + sweet pickle relish + pinch garlic powder. Spread as base.',
          fr: 'Mélanger parts égales mayo + ketchup + moutarde américaine + relish de cornichons sucrés + une pincée d\'ail en poudre. Étaler comme base.',
        },
        qtyPerPizza: { amount: 60, unit: 'g' },
        isCommonPantry: true,
      },
      {
        id: 'ground_beef', category: 'meat', bakeOrder: 'before',
        name: { en: 'Ground beef (seasoned)', fr: 'Bœuf haché (assaisonné)' },
        prepNote: {
          en: 'Season with salt, pepper, garlic powder. Pan-fry in small crumbles until just cooked — finish in oven on pizza.',
          fr: 'Assaisonner avec sel, poivre, ail en poudre. Poêler en petites miettes jusqu\'à juste cuit — terminer au four sur la pizza.',
          timing: 10,
        },
        qtyPerPizza: { amount: 100, unit: 'g' },
        goodEnough: { name: { en: 'Any ground beef 80/20 lean/fat ratio', fr: 'Tout bœuf haché ratio 80/20 maigre/gras' } },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'Huber\'s Butchery', 'Ryan\'s Grocery'], note: 'Ground beef less common — ask butcher to mince fresh. Huber\'s has excellent quality.' },
          france: { shops: ['Butcher', 'Carrefour', 'Monoprix'], note: 'Bœuf haché — standard in every supermarket' },
          uk: { shops: ['Any supermarket', 'butcher'], note: '20% fat mince for best flavour' },
          us: { shops: ['Any supermarket'], note: '80/20 ground beef — standard everywhere' },
          australia: { shops: ['Coles', 'Woolworths', 'butcher'] },
        },
      },
      {
        id: 'cheddar_cheese', category: 'cheese', bakeOrder: 'before',
        name: { en: 'Cheddar cheese (sliced or grated)', fr: 'Cheddar (tranché ou râpé)' },
        prepNote: { en: 'Use mature cheddar for stronger flavour. Layer generously — it is the burger experience.', fr: 'Utiliser un cheddar mature pour plus de saveur. Coucher généreusement — c\'est l\'expérience burger.' },
        qtyPerPizza: { amount: 80, unit: 'g' },
        goodEnough: { name: { en: 'American cheese slices (more authentic to the burger experience)', fr: 'Fromage américain en tranches (plus authentique à l\'expérience burger)' } },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'FairPrice Finest', 'Marketplace'], note: 'Mainland or Anchor cheddar — dairy section' },
          france: { shops: ['Carrefour', 'Monoprix', 'Marks & Spencer Food'], note: 'Cheddar in most supermarkets — international cheese section' },
          uk: { shops: ['Any supermarket'], note: 'Mature cheddar everywhere' },
          us: { shops: ['Any supermarket'], note: 'Sharp cheddar or American cheese' },
          australia: { shops: ['Coles', 'Woolworths'], note: 'Tasty or vintage cheddar' },
        },
      },
      {
        id: 'dill_pickles', category: 'finish', bakeOrder: 'after',
        name: { en: 'Dill pickles (sliced)', fr: 'Cornichons à l\'aneth (tranchés)' },
        prepNote: { en: 'Add cold after baking — the cold crunch and acidity complete the burger experience.', fr: 'Ajouter froids après cuisson — le croquant froid et l\'acidité complètent l\'expérience burger.' },
        qtyPerPizza: { amount: 40, unit: 'g' },
        goodEnough: { name: { en: 'French cornichons', fr: 'Cornichons français' } },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'Marketplace', 'Jason\'s'], note: 'Vlasic or Claussen dill pickles in international section' },
          france: { shops: ['Any supermarket'], note: 'Cornichons à l\'aneth in most supermarkets' },
          uk: { shops: ['Tesco', 'Waitrose', 'Costco'], note: 'Dill pickles or gherkins' },
          us: { shops: ['Any supermarket'], note: 'Dill pickles — every supermarket' },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
      },
    ],
  ...
  {
    id: 'meat_lovers',
    name: { en: 'Meat Lovers', fr: 'Amateurs de Viande' },
    story: {
      en: 'The ultimate carnivore pizza — red base, pepperoni, sausage, bacon, ham, melted mozzarella. A crowd favourite everywhere.',
      fr: 'La pizza carnivore ultime — base rouge, pepperoni, saucisse, bacon, jambon, mozzarella fondue. Un favori du public partout.',
    },
    category: 'fusion', region: 'american',
    base: 'tomato_cooked',
    season: ['all'],
    occasion: ['party', 'kids', 'quick'],
    dietary: ['no_fish', 'no_nuts'],
    budget: 2, complexity: 1, prepMinutes: 10, ovenTemp: 'high',
    wine: ['rw'],
    flavour: { richness: 5, boldness: 4, creative: 1, refined: 1 },
    compatibleStyles: ['neapolitan', 'newyork', 'pan'],
    wineNote: { en: 'Montepulciano d\'Abruzzo · rustic red for meat-heavy pizza', fr: 'Montepulciano d\'Abruzzo · rouge rustique pour pizza chargée en viande' },
    ingredients: [
      {
        id: 'tomato_sauce_cooked', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Cooked tomato sauce', fr: 'Sauce tomate cuite' },
        prepNote: { en: 'Simmer canned tomatoes with garlic and olive oil 15 min. Must be thick — all the meat releases liquid.', fr: 'Mijoter tomates en conserve avec ail et huile d\'olive 15 min. Doit être épais — toutes les viandes libèrent du liquide.', timing: 15 },
        qtyPerPizza: { amount: 80, unit: 'g' },
        isCommonPantry: true,
      },
      {
        id: 'mozzarella_low_moisture', category: 'cheese', bakeOrder: 'before',
        name: { en: 'Low-moisture mozzarella (grated)', fr: 'Mozzarella faible humidité (râpée)' },
        prepNote: { en: 'Grate directly — covers all the meat evenly. Low-moisture essential given the fat content of toppings.', fr: 'Râper directement — couvre toutes les viandes uniformément. Faible humidité essentielle vu la teneur en graisse des garnitures.' },
        qtyPerPizza: { amount: 100, unit: 'g' },
        goodEnough: { name: { en: 'Any grated pizza mozzarella', fr: 'Toute mozzarella pizza râpée' } },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant'], note: 'Anchor or Mainland grated mozzarella in dairy section' },
          france: { shops: ['Any supermarket'], note: 'Mozzarella râpée pour pizza in every supermarket' },
          uk: { shops: ['Any supermarket'] },
          us: { shops: ['Any supermarket'], note: 'Pre-shredded mozzarella everywhere' },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
      },
      {
        id: 'pepperoni', category: 'meat', bakeOrder: 'before',
        name: { en: 'Pepperoni', fr: 'Pepperoni' },
        prepNote: { en: 'Layer generously — they cup and crisp beautifully in the oven.', fr: 'Coucher généreusement — ils se recroquevillent et deviennent croustillants au four.' },
        qtyPerPizza: { amount: 40, unit: 'g' },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'Marketplace', 'Ryan\'s Grocery'], note: 'Hormel or local brand in cold cuts section' },
          france: { shops: ['Carrefour', 'Monoprix', 'Italian deli'], note: 'Pepperoni in charcuterie or Italian section' },
          uk: { shops: ['Any supermarket'] },
          us: { shops: ['Any supermarket'], note: 'Hormel, Bridgford — everywhere' },
          australia: { shops: ['Coles', 'Woolworths', 'deli'] },
        },
      },
      {
        id: 'italian_sausage', category: 'meat', bakeOrder: 'before',
        name: { en: 'Italian sausage (crumbled)', fr: 'Saucisse italienne (émiettée)' },
        prepNote: { en: 'Remove casing, crumble raw onto pizza — cooks perfectly in oven.', fr: 'Retirer le boyau, émietter cru sur la pizza — cuit parfaitement au four.' },
        qtyPerPizza: { amount: 50, unit: 'g' },
        goodEnough: { name: { en: 'Any pork sausage, casing removed and crumbled', fr: 'Toute saucisse de porc, boyau retiré et émiettée' } },
        whereToFind: {
          singapore: { shops: ['Huber\'s Butchery', 'Ryan\'s Grocery', 'Culina'], note: 'Italian sausage at specialty butchers — or use any pork sausage' },
          france: { shops: ['Butcher', 'Carrefour', 'Italian deli'], note: 'Saucisse italienne or chair à saucisse' },
          uk: { shops: ['Waitrose', 'Marks & Spencer', 'Italian deli'] },
          us: { shops: ['Any supermarket'], note: 'Jimmy Dean or Johnsonville Italian sausage everywhere' },
          australia: { shops: ['Coles', 'Woolworths', 'butcher'] },
        },
      },
      {
        id: 'bacon_rashers', category: 'meat', bakeOrder: 'before',
        name: { en: 'Bacon (diced)', fr: 'Bacon (coupé en dés)' },
        prepNote: { en: 'Dice and scatter raw — renders and crisps in the oven. No need to pre-cook.', fr: 'Couper en dés et disperser cru — fond et devient croustillant au four. Pas besoin de précuire.' },
        qtyPerPizza: { amount: 40, unit: 'g' },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Giant'], note: 'Streaky bacon in most supermarkets' },
          france: { shops: ['Any supermarket'], note: 'Lardons fumés or tranches de bacon' },
          uk: { shops: ['Any supermarket'] },
          us: { shops: ['Any supermarket'] },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
      },
      {
        id: 'cooked_ham', category: 'meat', bakeOrder: 'before',
        name: { en: 'Cooked ham (diced)', fr: 'Jambon cuit (coupé en dés)' },
        prepNote: { en: 'Dice into small cubes — distributes evenly across the pizza.', fr: 'Couper en petits cubes — se distribue uniformément sur la pizza.' },
        qtyPerPizza: { amount: 40, unit: 'g' },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage'], note: 'Cooked ham in cold cuts section' },
          france: { shops: ['Any supermarket'], note: 'Jambon de Paris — standard in every supermarket' },
          uk: { shops: ['Any supermarket'] },
          us: { shops: ['Any supermarket'] },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
  ...
  {
    id: 'stracciatella_pomodoro',
    name: { en: 'Stracciatella e Pomodoro', fr: 'Stracciatella e Pomodoro' },
    story: {
      en: 'Summer in a pizza — raw crushed tomatoes, cold stracciatella added after baking, torn basil. Pure and clean.',
      fr: 'L\'été en pizza — tomates écrasées crues, stracciatella froide ajoutée après cuisson, basilic déchiré. Pur et net.',
    },
    category: 'classic_italian', region: 'neapolitan',
    base: 'tomato_raw',
    season: ['summer'],
    ...
    budget: 3, complexity: 1, prepMinutes: 5, ovenTemp: 'high',
    wine: ['cw', 'sp'],
    flavour: { richness: 2, boldness: 1, creative: 2, refined: 5 },
    compatibleStyles: ['neapolitan', 'sourdough', 'pizza_romana'],
    wineNote: { en: 'Fiano di Avellino · delicate white matches the fresh cheese', fr: 'Fiano di Avellino · blanc délicat s\'accorde avec le fromage frais' },
    ingredients: [
      {
        id: 'san_marzano', category: 'sauce', bakeOrder: 'before',
        name: { en: 'San Marzano DOP tomatoes (crushed)', fr: 'Tomates San Marzano DOP (écrasées)' },
        prepNote: { en: 'Hand-crush only — salt lightly, never cook. This is the base.', fr: 'Écraser à la main uniquement — saler légèrement, ne jamais cuire. C\'est la base.' },
        qtyPerPizza: { amount: 80, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Mutti Polpa crushed tomatoes', fr: 'Mutti Polpa tomates concassées' } },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'Marketplace', 'Culina'], note: 'Mutti Polpa at Cold Storage and Marketplace' },
          france: { shops: ['Carrefour', 'Grand Frais', 'Monoprix'] },
          uk: { shops: ['Waitrose', 'Sainsbury\'s', 'Ocado'] },
          us: { shops: ['Whole Foods', 'Eataly', 'Italian specialty stores'] },
          australia: { shops: ['Harris Farm', 'Coles', 'IGA'] },
        },
      },
      {
        id: 'stracciatella', category: 'cheese', bakeOrder: 'after',
        name: { en: 'Stracciatella', fr: 'Stracciatella' },
        prepNote: { en: 'Spoon generously in large dollops after baking — the cold creaminess against hot crust is the point. Never bake it.', fr: 'Déposer généreusement en grandes cuillerées après cuisson — la fraîcheur crémeuse contre la croûte chaude est l\'essentiel. Ne jamais enfourner.' },
        qtyPerPizza: { amount: 80, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Burrata, torn open and spread', fr: 'Burrata, ouverte et étalée' }, note: { en: 'Burrata interior is essentially stracciatella — identical experience', fr: 'L\'intérieur de la burrata est essentiellement de la stracciatella — expérience identique' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Huber\'s Butchery', 'Marketplace'], note: 'Increasingly available — Ryan\'s Grocery and Culina most reliable' },
          france: { shops: ['Grand Frais', 'Italian deli', 'Monoprix Bio'], note: 'Stracciatella in Italian delis and Grand Frais cheese section' },
          uk: { shops: ['Waitrose', 'M&S', 'Lina Stores', 'Italian deli'], note: 'Increasingly common in premium supermarkets' },
          us: { shops: ['Whole Foods', 'Eataly', 'Italian deli', 'Trader Joe\'s'], note: 'Trader Joe\'s carries it seasonally' },
          australia: { shops: ['Harris Farm', 'IGA', 'Italian deli'], note: 'Growing availability in specialty stores' },
        },
      },
      {
        id: 'fresh_basil', category: 'finish', bakeOrder: 'after',
        name: { en: 'Fresh basil (torn)', fr: 'Basilic frais (déchiré)' },
        prepNote: { en: 'Tear and scatter after baking.', fr: 'Déchirer et parsemer après cuisson.' },
        qtyPerPizza: { amount: 5, unit: 'leaves' },
      },
      {
        id: 'evo_oil', category: 'finish', bakeOrder: 'after',
        name: { en: 'Extra virgin olive oil', fr: 'Huile d\'olive extra vierge' },
        prepNote: { en: 'Drizzle after adding stracciatella.', fr: 'Arroser après avoir ajouté la stracciatella.' },
        isCommonPantry: true,
        qtyPerPizza: { amount: 1, unit: 'drizzle' },
      },
    ],
  ...
  {
    id: 'pistacchio_mortadella',
    name: { en: 'Pistacchio e Mortadella', fr: 'Pistache et Mortadelle' },
    story: {
      en: 'Bologna\'s gift to the pizza world — pistachio cream base, cloud-like mortadella added cold after baking, stracciatella.',
      fr: 'Le cadeau de Bologne au monde de la pizza — base crème pistache, mortadelle aérienne ajoutée froide après cuisson, stracciatella.',
    },
    category: 'classic_italian', region: 'neapolitan',
    base: 'other',
    season: ['all'],
    occasion: ['impress'],
    dietary: ['no_fish'],
    budget: 3, complexity: 2, prepMinutes: 10, ovenTemp: 'high',
    wine: ['cw', 'sp'],
    flavour: { richness: 4, boldness: 2, creative: 4, refined: 5 },
    compatibleStyles: ['neapolitan', 'sourdough', 'pizza_romana'],
    wineNote: { en: 'Franciacorta · Italian sparkling perfect with mortadella', fr: 'Franciacorta · pétillant italien parfait avec la mortadelle' },
    ingredients: [
      {
        id: 'pistachio_cream', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Pistachio cream (crema di pistacchio)', fr: 'Crème de pistache (crema di pistacchio)' },
        prepNote: { en: 'Spread thinly as base — very rich, a little goes a long way. Authentic Sicilian pistachio cream (unsweetened) is ideal.', fr: 'Étaler finement comme base — très riche, peu suffit. La crème de pistache sicilienne authentique (non sucrée) est idéale.' },
        qtyPerPizza: { amount: 50, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Blend 100g roasted pistachios + 2 tbsp olive oil + pinch salt until smooth', fr: 'Mixer 100g pistaches grillées + 2 cas huile d\'olive + pincée de sel jusqu\'à consistance lisse' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Marketplace', 'Huber\'s'], note: 'Crema di pistacchio from Italian specialty import section — growing availability' },
          france: { shops: ['Italian deli', 'Grand Frais', 'Monoprix Bio'], note: 'Crème de pistache in Italian delis and specialty food stores' },
          uk: { shops: ['Waitrose', 'Whole Foods', 'Lina Stores', 'Italian deli'] },
          us: { shops: ['Eataly', 'Whole Foods', 'Italian specialty stores'], online: ['Amazon'] },
          australia: { shops: ['Italian deli', 'specialty food stores', 'Harris Farm'] },
        },
      },
      {
        id: 'fior_di_latte', category: 'cheese', bakeOrder: 'before',
        name: { en: 'Fior di latte (or fresh mozzarella)', fr: 'Fior di latte (ou mozzarella fraîche)' },
        prepNote: { en: 'Slice 5mm, drain 30 min. Scatter on pistachio cream before baking.', fr: 'Trancher à 5mm, égoutter 30 min. Disperser sur la crème pistache avant cuisson.', timing: 30 },
        qtyPerPizza: { amount: 80, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Fresh mozzarella ball', fr: 'Boule de mozzarella fraîche' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Marketplace'] },
          france: { shops: ['Grand Frais', 'Italian deli', 'Monoprix'] },
          uk: { shops: ['Waitrose', 'M&S', 'Italian deli'] },
          us: { shops: ['Whole Foods', 'Eataly', 'Italian deli'] },
          australia: { shops: ['Harris Farm', 'IGA', 'Italian deli'] },
        },
      },
      {
        id: 'mortadella', category: 'meat', bakeOrder: 'after',
        name: { en: 'Mortadella (large thin slices)', fr: 'Mortadelle (grandes tranches fines)' },
        prepNote: { en: 'Ask deli to slice paper-thin. Lay cold over hot pizza in large billowing folds immediately after baking — the heat gently warms it without cooking it.', fr: 'Demander à la charcuterie de trancher très finement. Poser froide sur la pizza chaude en grands plis généreux immédiatement après cuisson — la chaleur la réchauffe doucement sans la cuire.' },
        qtyPerPizza: { amount: 80, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Any good-quality mortadella, sliced thin at deli counter', fr: 'Toute mortadelle de bonne qualité, tranchée finement au comptoir charcuterie' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Huber\'s Butchery', 'Marketplace'], note: 'Specialty butchers and delis — growing availability. Ask for thin-sliced.' },
          france: { shops: ['Italian deli', 'Grand Frais', 'Carrefour (packaged)'], note: 'Mortadelle in Italian delis; Bologne sausage substitute in supermarkets (not the same)' },
          uk: { shops: ['Waitrose deli', 'Lina Stores', 'Italian deli', 'M&S'], note: 'Deli counter for fresh-sliced; packaged available in Waitrose' },
          us: { shops: ['Whole Foods deli', 'Eataly', 'Italian deli', 'Costco'], note: 'Boar\'s Head mortadella at deli counters nationwide' },
          australia: { shops: ['Italian deli', 'specialty butcher', 'Coles deli counter'], note: 'Good Italian delis in Melbourne and Sydney' },
        },
      },
      {
        id: 'stracciatella', category: 'cheese', bakeOrder: 'after',
        name: { en: 'Stracciatella', fr: 'Stracciatella' },
        prepNote: { en: 'Spoon in small dollops over the mortadella folds after baking.', fr: 'Déposer en petites cuillerées sur les plis de mortadelle après cuisson.' },
        qtyPerPizza: { amount: 50, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Burrata, torn open', fr: 'Burrata, ouverte' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Marketplace'] },
          france: { shops: ['Italian deli', 'Grand Frais'] },
          uk: { shops: ['Waitrose', 'M&S', 'Italian deli'] },
          us: { shops: ['Whole Foods', 'Eataly', 'Trader Joe\'s'] },
          australia: { shops: ['Harris Farm', 'Italian deli'] },
        },
      },
      {
        id: 'crushed_pistachios', category: 'finish', bakeOrder: 'after',
        name: { en: 'Crushed roasted pistachios', fr: 'Pistaches grillées concassées' },
        prepNote: { en: 'Scatter generously after adding mortadella — essential crunch and colour.', fr: 'Parsemer généreusement après avoir ajouté la mortadelle — croquant et couleur essentiels.' },
        qtyPerPizza: { amount: 20, unit: 'g' },
        whereToFind: {
          singapore: { shops: ['FairPrice', 'Cold Storage', 'Phoon Huat'], note: 'Roasted pistachios in nut or baking section' },
          france: { shops: ['Carrefour', 'Monoprix', 'naturalia'], note: 'Pistaches grillées en rayon fruits secs' },
          uk: { shops: ['Any supermarket'] },
          us: { shops: ['Trader Joe\'s', 'Whole Foods', 'any supermarket'] },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
      },
    ],
  ...
  {
    id: 'truffle_egg',
    name: { en: 'Truffle & Egg', fr: 'Truffe & Œuf' },
    story: {
      en: 'A decadent bianca — truffle cream base, whole egg baked in centre, parmesan, black truffle shavings after baking.',
      fr: 'Une bianca décadente — base crème truffe, œuf entier cuit au centre, parmesan, copeaux de truffe noire après cuisson.',
    },
    category: 'gourmet', region: 'neapolitan',
    base: 'truffle_cream',
    ...
    occasion: ['impress'],
    dietary: ['veg', 'no_nuts', 'no_fish'],
    budget: 3, complexity: 2, prepMinutes: 5, ovenTemp: 'high',
    wine: ['cw', 'rw'],
    flavour: { richness: 5, boldness: 3, creative: 4, refined: 5 },
    compatibleStyles: ['neapolitan', 'sourdough', 'pizza_romana'],
    wineNote: { en: 'White Burgundy · Chardonnay and truffle is a timeless match', fr: 'Bourgogne Blanc · Chardonnay et truffe, un accord intemporel' },
    ingredients: [
      {
        id: 'truffle_cream', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Truffle cream (crema al tartufo)', fr: 'Crème au truffe (crema al tartufo)' },
        prepNote: { en: 'Spread as base. Do not over-apply — truffle is powerful. A thin even layer is enough.', fr: 'Étaler comme base. Ne pas trop appliquer — la truffe est puissante. Une fine couche uniforme suffit.' },
        qtyPerPizza: { amount: 50, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Mix crème fraîche + 1 tsp black truffle paste + salt', fr: 'Mélanger crème fraîche + 1 cc pâte de truffe noire + sel' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Marketplace', 'Huber\'s'], note: 'Urbani or Tartufi Jimmy truffle cream — specialty food stores' },
          france: { shops: ['Épicerie fine', 'Monoprix Gourmet', 'Le Bon Marché'], note: 'Crème de truffe in gourmet food sections' },
          uk: { shops: ['Waitrose', 'Whole Foods', 'Fortnum & Mason', 'deli'], online: ['Ocado'] },
          us: { shops: ['Whole Foods', 'Eataly', 'Williams Sonoma'], online: ['Amazon', 'Goldbelly'] },
          australia: { shops: ['Specialty food stores', 'David Jones Food Hall'] },
        },
      },
      {
        id: 'fior_di_latte', category: 'cheese', bakeOrder: 'before',
        name: { en: 'Fior di latte (or fresh mozzarella)', fr: 'Fior di latte (ou mozzarella fraîche)' },
        prepNote: { en: 'Slice 5mm, drain 30 min. Arrange around the edge — leave center clear for the egg.', fr: 'Trancher à 5mm, égoutter 30 min. Disposer en bordure — laisser le centre libre pour l\'œuf.', timing: 30 },
        qtyPerPizza: { amount: 80, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Fresh mozzarella ball', fr: 'Boule de mozzarella fraîche' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Marketplace'] },
          france: { shops: ['Grand Frais', 'Italian deli'] },
          uk: { shops: ['Waitrose', 'M&S'] },
          us: { shops: ['Whole Foods', 'Eataly'] },
          australia: { shops: ['Harris Farm', 'Italian deli'] },
        },
      },
      {
        id: 'whole_egg', category: 'base', bakeOrder: 'before',
        name: { en: 'Whole egg (free-range)', fr: 'Œuf entier (plein air)' },
        prepNote: { en: 'Crack into center of pizza in last 3 minutes of baking — yolk should remain runny. For high-heat ovens (450°C+): crack in at the very end, just 90 seconds. For home ovens: crack in at start, bake normally.', fr: 'Casser au centre de la pizza dans les 3 dernières minutes de cuisson — le jaune doit rester coulant. Pour fours haute température (450°C+) : casser à la toute fin, 90 secondes seulement. Pour fours domestiques : casser au début, cuire normalement.', timing: 3 },
        qtyPerPizza: { amount: 1, unit: 'pcs' },
        isCommonPantry: true,
      },
      {
        id: 'parmesan', category: 'cheese', bakeOrder: 'before',
        name: { en: 'Parmigiano Reggiano (grated)', fr: 'Parmigiano Reggiano (râpé)' },
        prepNote: { en: 'Grate finely over the whole surface before baking.', fr: 'Râper finement sur toute la surface avant cuisson.' },
        qtyPerPizza: { amount: 30, unit: 'g' },
        goodEnough: { name: { en: 'Grana Padano — similar profile, more affordable', fr: 'Grana Padano — profil similaire, plus abordable' } },
        whereToFind: {
          singapore: { shops: ['Cold Storage', 'Marketplace', 'FairPrice Finest'], note: 'Parmigiano Reggiano in cheese section — also available pre-grated' },
          france: { shops: ['Any supermarket'], note: 'Parmesan in every French supermarket' },
          uk: { shops: ['Any supermarket'] },
          us: { shops: ['Any supermarket'] },
          australia: { shops: ['Coles', 'Woolworths'] },
        },
      ...
      {
        id: 'black_truffle_shavings', category: 'finish', bakeOrder: 'after',
        name: { en: 'Black truffle shavings (or truffle oil)', fr: 'Copeaux de truffe noire (ou huile de truffe)' },
        prepNote: { en: 'Shave fresh truffle after baking, or use 4–5 drops of quality truffle oil. Never cook truffle — heat destroys the aroma.', fr: 'Raser la truffe fraîche après cuisson, ou utiliser 4–5 gouttes d\'huile de truffe de qualité. Ne jamais cuire la truffe — la chaleur détruit l\'arôme.' },
        qtyPerPizza: { amount: 5, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Quality truffle oil (Urbani or La Madia Regale)', fr: 'Huile de truffe de qualité (Urbani ou La Madia Regale)' }, note: { en: 'Use sparingly — 4 drops max. Cheap truffle oil is synthetic and ruins the dish.', fr: 'Utiliser avec parcimonie — 4 gouttes max. L\'huile de truffe bon marché est synthétique et gâche le plat.' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Marketplace'], note: 'Truffle oil widely available; fresh truffle very rare — use oil' },
          france: { shops: ['Épicerie fine', 'Périgord specialty shops', 'Monoprix Gourmet'], note: 'Fresh truffle in season (Nov–Feb) at Périgord specialty stores' },
          uk: { shops: ['Waitrose', 'Whole Foods', 'Fortnum & Mason'], online: ['Ocado'] },
          us: { shops: ['Whole Foods', 'Eataly', 'Williams Sonoma'], online: ['Regalis Foods', 'Amazon'] },
          australia: { shops: ['Specialty food stores', 'Périgord Truffles WA'], note: 'Australian truffle season June–August — excellent quality' },
        },
      },
    ],
  },

  {
    ...
    name: { en: 'Prosciutto e Stracciatella Romana', fr: 'Prosciutto e Stracciatella Romana' },
    story: {
      en: 'Roman-style white pizza — no tomato, just stracciatella cream pooling over prosciutto crudo added cold after baking.',
      fr: 'Pizza blanche à la romaine — sans tomate, juste la stracciatella crémeuse coulant sur le prosciutto crudo ajouté froid après cuisson.',
    },
    category: 'classic_italian', region: 'roman',
    base: 'bianca_oil',
    season: ['all'],
    ...
    budget: 3, complexity: 1, prepMinutes: 5, ovenTemp: 'high',
    wine: ['cw', 'sp'],
    flavour: { richness: 3, boldness: 2, creative: 2, refined: 5 },
    compatibleStyles: ['pizza_romana', 'roman'],
    wineNote: { en: 'Vermentino · crisp Sardinian white matches prosciutto perfectly', fr: 'Vermentino · blanc sarde vif s\'accorde parfaitement avec le prosciutto' },
    ingredients: [
      {
        id: 'evo_oil_base', category: 'sauce', bakeOrder: 'before',
        name: { en: 'Extra virgin olive oil (base)', fr: 'Huile d\'olive extra vierge (base)' },
        prepNote: { en: 'Drizzle generously as the only base — this is a true bianca. No tomato, no cream.', fr: 'Arroser généreusement comme seule base — c\'est une vraie bianca. Sans tomate, sans crème.' },
        qtyPerPizza: { amount: 20, unit: 'ml' },
        isCommonPantry: true,
      },
      {
        id: 'fior_di_latte', category: 'cheese', bakeOrder: 'before',
        name: { en: 'Fior di latte (or fresh mozzarella)', fr: 'Fior di latte (ou mozzarella fraîche)' },
        prepNote: { en: 'Slice 5mm, drain 30 min before baking. Distribute evenly.', fr: 'Trancher à 5mm, égoutter 30 min avant cuisson. Distribuer uniformément.', timing: 30 },
        qtyPerPizza: { amount: 100, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Fresh mozzarella ball', fr: 'Boule de mozzarella fraîche' } },
        whereToFind: {
      ...
      },
      {
        id: 'stracciatella', category: 'cheese', bakeOrder: 'after',
        name: { en: 'Stracciatella', fr: 'Stracciatella' },
        prepNote: { en: 'Spoon generously over the hot pizza immediately after baking — cold cream on hot crust.', fr: 'Déposer généreusement sur la pizza chaude immédiatement après cuisson — crème froide sur croûte chaude.' },
        qtyPerPizza: { amount: 80, unit: 'g' },
        hardToFind: true,
        goodEnough: { name: { en: 'Burrata, torn open', fr: 'Burrata, ouverte' } },
        whereToFind: {
      ...
      {
        id: 'prosciutto_crudo', category: 'meat', bakeOrder: 'after',
        name: { en: 'Prosciutto crudo (thin-sliced)', fr: 'Prosciutto crudo (tranché finement)' },
        prepNote: { en: 'Drape cold over the stracciatella in generous folds immediately after baking. Never cook prosciutto crudo — it turns tough and loses its delicacy.', fr: 'Draper froid sur la stracciatella en plis généreux immédiatement après cuisson. Ne jamais cuire le prosciutto crudo — il durcit et perd sa délicatesse.' },
        qtyPerPizza: { amount: 60, unit: 'g' },
        goodEnough: { name: { en: 'Any good quality prosciutto di Parma or San Daniele', fr: 'Tout prosciutto di Parma ou San Daniele de bonne qualité' } },
        whereToFind: {
          singapore: { shops: ['Ryan\'s Grocery', 'Culina', 'Huber\'s Butchery', 'Cold Storage'], note: 'Prosciutto di Parma at specialty delis — ask for thin-sliced' },
          france: { shops: ['Italian deli', 'Grand Frais', 'Carrefour'], note: 'Jambon cru italien — available in most supermarkets' },
          uk: { shops: ['Waitrose', 'M&S', 'deli counter', 'Sainsbury\'s'] },
          us: { shops: ['Whole Foods', 'Trader Joe\'s', 'Eataly', 'Italian deli'] },
          australia: { shops: ['Coles deli', 'Woolworths deli', 'Italian deli'] },
        },
      },
      {
        id: 'evo_oil_finish', category: 'finish', bakeOrder: 'after',
        name: { en: 'Extra virgin olive oil (finish)', fr: 'Huile d\'olive extra vierge (finition)' },
        prepNote: { en: 'Final drizzle after adding prosciutto.', fr: 'Filet final après avoir ajouté le prosciutto.' },
        isCommonPantry: true,
        qtyPerPizza: { amount: 1, unit: 'drizzle' },
      },
    ],
...
export const DESSERT_PIZZAS: Pizza[] = [
...

  {
    ...
    flavour: { richness: 4, boldness: 2, creative: 4, refined: 5 },
    ingredients: [
      { id: 'mascarpone', category: 'base', bakeOrder: 'before', name: { en: 'Mascarpone', fr: 'Mascarpone' }, qtyPerPizza: { amount: 60, unit: 'g' }, prepNote: { en: 'Spread as base', fr: 'Étaler comme base' } },
      ING.fig,
      ING.honey,
      ING.walnuts,
    ],
...

  {
    ...
    ingredients: [
      { id: 'speculoos_spread', category: 'base', bakeOrder: 'before', name: { en: 'Speculoos spread', fr: 'Pâte de speculoos' }, qtyPerPizza: { amount: 60, unit: 'g' } },
      { id: 'banana', category: 'veg', bakeOrder: 'after', name: { en: 'Banana (sliced)', fr: 'Banane (tranchée)' }, qtyPerPizza: { amount: 1, unit: 'pcs' }, prepNote: { en: 'Add after baking', fr: 'Ajouter après cuisson' } },
      { id: 'caramel_drizzle', category: 'finish', bakeOrder: 'after', name: { en: 'Caramel drizzle', fr: 'Filet de caramel' }, qtyPerPizza: { amount: 1, unit: 'drizzle' } },
      ING.icingSugar,
    ],
    compatibleStyles: ['neapolitan', 'pizza_romana', 'sourdough'],
  },

  {
    ...
    ingredients: [
      { id: 'vanilla_cream', category: 'base', bakeOrder: 'before', name: { en: 'Vanilla pastry cream', fr: 'Crème pâtissière vanille' }, qtyPerPizza: { amount: 80, unit: 'g' }, prepNote: { en: 'Make ahead — 15 min', fr: 'Préparer à l\'avance — 15 min' } },
      { id: 'sugar_crust', category: 'finish', bakeOrder: 'after', name: { en: 'Caster sugar (blowtorch to caramelise)', fr: 'Sucre semoule (chalumeau pour caraméliser)' }, qtyPerPizza: { amount: 1, unit: 'tbsp' }, prepNote: { en: 'Sprinkle after baking, caramelise with blowtorch at table', fr: 'Saupoudrer après cuisson, caraméliser au chalumeau à table' } },
      { id: 'mixed_berries', category: 'finish', bakeOrder: 'after', name: { en: 'Mixed berries', fr: 'Fruits rouges mélangés' }, qtyPerPizza: { amount: 60, unit: 'g' } },
    ],
...

  {
    ...
    ingredients: [ING.cremeFraiche, { id: 'caramel_drizzle', category: 'finish', bakeOrder: 'after', name: { en: 'Caramel drizzle', fr: 'Filet de caramel' }, qtyPerPizza: { amount: 1, unit: 'drizzle' } }, ING.almondFlakes, ING.seaSalt, ING.walnuts],
    compatibleStyles: ['neapolitan', 'pizza_romana', 'sourdough'],
  },
