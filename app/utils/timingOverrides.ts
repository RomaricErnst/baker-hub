...
export type TimingOverrides = { mix?: number; pref?: number; feed?: number; refresh?: number; prefLocked?: boolean; feedLocked?: boolean };
...
export function normalizeTimingOverrides(value: unknown): TimingOverrides {
  ...
  if (source.feedLocked === true && result.feed !== undefined) result.feedLocked = true;
  return result;
}
