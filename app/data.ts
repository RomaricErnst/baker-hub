...
export const PIZZA_STYLES = {
  ...
  newyork: {
    ...
    emoji: '🗽',
    image: '/pizzas/ny_pepperoni_slice.png',
  ...
  pizza_romana: {
    ...
    emoji: '🫓',
    image: '/pizzas/carciofi_romana.png',
  ...
  roman: {
    ...
    emoji: '🏛️',
    image: '/pizzas/teglia_patata_provola.png',
  ...
  pan: {
    ...
    nameFr: 'Pan / Detroit',
    emoji: '🍞',
    image: '/pizzas/detroit_red_top.png',
