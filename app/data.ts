...
export const PIZZA_STYLES = {
  ...
  pizza_romana: {
    ...
    oil: 2, sugar: 0,
    pref: 'none', bulkH: 2, ballW: 260,
    ovenNote: 'Roll very thin with a rolling pin — do NOT hand-stretch.',
    ovenNoteFr: 'Étaler très finement au rouleau — ne pas étirer à la main.',
    flourNote: 'Medium-strong flour W250-280. Low hydration = easy to handle.',
    flourNoteFr: 'Farine mi-forte W250-280. Faible hydratation = facile à étaler.',
  },
  roman: {
    name: 'Roman Teglia',
...
export const BREAD_STYLES = {
  pain_campagne: {
    ...
    emoji: '🍞',
    image: '/images/approved/bread/campagne.webp',
  ...
  pain_levain: {
    ...
    emoji: '🫙',
    image: '/images/approved/bread/levain.webp',
  ...
  baguette: {
    ...
    nameFr: 'Baguette',
    emoji: '🥖',
    image: '/images/approved/bread/baguette.webp',
  ...
  pain_complet: {
    ...
    nameFr: 'Pain complet',
    emoji: '🌾',
    image: '/images/approved/bread/complet.webp',
  ...
  pain_seigle: {
    ...
    emoji: '🌑',
    image: '/images/approved/bread/seigle.webp',
  ...
  fougasse: {
    ...
    nameFr: 'Fougasse',
    emoji: '🌿',
    image: '/images/approved/bread/fougasse.webp',
  ...
  brioche: {
    ...
    nameFr: 'Brioche',
    emoji: '🥐',
    image: '/images/approved/bread/brioche.webp',
  ...
  pain_mie: {
    ...
    nameFr: 'Pain de mie',
    emoji: '🍞',
    image: '/images/approved/bread/mie.webp',
  ...
  pain_viennois: {
    ...
    emoji: '🥐',
    image: '/images/approved/bread/viennois.webp',
