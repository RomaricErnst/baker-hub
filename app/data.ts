...
export const BREAD_STYLES = {
  ...
  pain_graines: {
    ...
    nameFr: 'Pain aux graines',
    emoji: '🌾',
    desc: 'Seeded loaf built on a soaker — seeds are pre-soaked so they never steal water from the dough. Moist, nutty crumb.',
    descFr: "Pain aux graines avec trempage — les graines sont trempées à l'avance pour ne pas voler l'eau de la pâte. Mie moelleuse, goût de noisette.",
    hydration: 73,
    salt: 2.0,
    yeast: 0.15,
    oil: 0,
    ...
    ballW: 800,
    ovenNote: 'Dutch oven: 240°C lid on 20min, lid off 20min.',
    flourNote: 'T65 base + 15–20% seeds (soaked).',
  },
  pain_seigle: {
    name: 'Pain de seigle',
