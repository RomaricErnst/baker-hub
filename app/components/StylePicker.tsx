...
const STYLE_ART: Record<string, { bg: string; svg: string }> = {
  neapolitan: {
    ...
    svg: `<circle cx="120" cy="72" r="65" fill="#6B4423" opacity=".88"/>
      <circle cx="120" cy="72" r="52" fill="#D43020" opacity=".82"/>
      <ellipse cx="100" cy="65" rx="14" ry="10" fill="#F0EBE0" opacity=".92"/>
      <ellipse cx="128" cy="62" rx="12" ry="9" fill="#F0EBE0" opacity=".88"/>
      <ellipse cx="115" cy="71" rx="9" ry="7" fill="#F0EBE0" opacity=".85"/>
      ...
      <text x="120" y="106" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#9C8248" font-style="italic">Neapolitan</text>`,
  },
  newyork: {
    bg: 'linear-gradient(160deg,#2A1A08,#1A1005)',
    svg: `<polygon points="120,14 212,84 28,84" fill="#9C8248" opacity=".9"/>
      <polygon points="120,18 206,82 34,82" fill="#6B4423" opacity=".82"/>
      ...
      <text x="120" y="104" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#9C8248" font-style="italic">New York</text>`,
  },
  pizza_romana: {
    bg: 'radial-gradient(ellipse at 50% 110%,#6B3A1F,#2C1800 50%,#140C00)',
    svg: `<circle cx="120" cy="72" r="65" fill="#6B4423" opacity=".75"/>
      <circle cx="120" cy="72" r="60" fill="#D4906A" opacity=".55"/>
      <circle cx="120" cy="72" r="55" fill="#E8C89A" opacity=".35"/>
      <ellipse cx="98" cy="66" rx="11" ry="8" fill="#F0EBE0" opacity=".85"/>
      <ellipse cx="132" cy="60" rx="9" ry="7" fill="#F0EBE0" opacity=".80"/>
      <ellipse cx="118" cy="74" rx="8" ry="6" fill="#F0EBE0" opacity=".78"/>
      ...
      <text x="120" y="138" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#9C8248" font-style="italic">Pizza Romana</text>`,
  },
  roman: {
    bg: 'linear-gradient(180deg,#18180E,#2A2010)',
    svg: `<rect x="22" y="33" width="196" height="50" rx="4" fill="#C4A855" opacity=".9"/>
      <rect x="22" y="33" width="196" height="43" rx="4" fill="#6B4423" opacity=".72"/>
      ...
      <text x="120" y="104" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#9C8248" font-style="italic">Roman Teglia</text>`,
  },
  pan: {
    ...
    svg: `<rect x="20" y="30" width="200" height="54" rx="3" fill="#4A3020"/>
      ...
      <rect x="38" y="34" width="28" height="37" rx="2" fill="#6B4423" opacity=".7"/>
      <rect x="86" y="34" width="26" height="37" rx="2" fill="#6B4423" opacity=".68"/>
      <rect x="130" y="34" width="26" height="37" rx="2" fill="#6B4423" opacity=".7"/>
      <rect x="170" y="34" width="32" height="37" rx="2" fill="#6B4423" opacity=".65"/>
      <circle cx="65" cy="49" r="7" fill="#8B2515" opacity=".75"/>
      <circle cx="110" cy="52" r="6.5" fill="#8B2515" opacity=".7"/>
      <text x="120" y="104" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#9C8248" font-style="italic">Pan / Detroit</text>`,
  },
  sourdough: {
    ...
    svg: `<ellipse cx="120" cy="72" rx="82" ry="13" fill="#2A1205"/>
      ...
      <ellipse cx="120" cy="64" rx="72" ry="10" fill="#6B4423" opacity=".78"/>
      <ellipse cx="98" cy="61" rx="13" ry="9" fill="#F0EBE0" opacity=".9" transform="rotate(-10 98 61)"/>
      <ellipse cx="124" cy="59" rx="12" ry="8" fill="#F0EBE0" opacity=".85" transform="rotate(8 124 59)"/>
      <ellipse cx="143" cy="63" rx="10" ry="7" fill="#F0EBE0" opacity=".88"/>
      <text x="120" y="99" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#9C8248" font-style="italic">Sourdough</text>`,
  },
  baguette: {
  ...
  brioche: {
    ...
    svg: `<ellipse cx="120" cy="79" rx="82" ry="12" fill="#8B4A10"/>
      ...
      <text x="120" y="104" text-anchor="middle" font-family="Georgia,serif" font-size="11" fill="#9C8248" font-style="italic">Brioche</text>`,
  },
};
