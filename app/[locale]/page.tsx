                ...
                return (
                  <div style={{ padding: '0 .1rem' }}>
                    ...
                    <div style={{ display: 'grid', gridTemplateColumns: showDiam ? '1fr 1fr' : '1fr', gap: '10px', marginBottom: '20px' }}>
                      ...
                      {showDiam && (
                        <div style={{ background: 'var(--warm)', border: '1px solid var(--border)', borderRadius: '12px', padding: '12px 14px' }}>
                          <div style={{ fontSize: '11px', color: '#8A7F78', fontFamily: 'DM Sans, sans-serif', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: '10px' }}>◎ Diameter</div>
                          <div style={{ display: 'flex', alignItems: 'center', gap: '8px', justifyContent: 'center' }}>
                            ...
                            <span style={{ fontSize: '1.4rem', fontWeight: 700, color: 'var(--char)', fontFamily: 'var(--font-dm-mono)', minWidth: '52px', textAlign: 'center' }}>{pizzaDiameter}<span style={{ fontSize: '.85rem', fontWeight: 500, color: 'var(--smoke)', marginLeft: '3px' }}>cm</span></span>
                      ...
                      {/* Weight tile */}
                      <div style={{ background: 'var(--warm)', border: '1px solid var(--border)', borderRadius: '12px', padding: '12px 14px' }}>
                        <div style={{ fontSize: '11px', color: '#8A7F78', fontFamily: 'DM Sans, sans-serif', textTransform: 'uppercase', letterSpacing: '.06em', marginBottom: '10px' }}>⚖ {isBread ? 'Weight / loaf' : 'Weight / ball'}</div>
                        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', justifyContent: 'center' }}>
                          ...
                          <div style={{ display: 'flex', alignItems: 'baseline', gap: '2px', minWidth: '70px', justifyContent: 'center' }}>
                            <input type="number" min={150} max={500} step={5} value={itemWeight}
                              ...
                              style={{ width: '52px', border: 'none', borderBottom: '2px solid var(--terra)', background: 'transparent', fontSize: '1.4rem', fontWeight: 700, color: 'var(--terra)', fontFamily: 'var(--font-dm-mono)', textAlign: 'center', outline: 'none', MozAppearance: 'textfield' } as React.CSSProperties} />
                            <span style={{ fontSize: '.85rem', fontWeight: 500, color: 'var(--smoke)' }}>g</span>
                          </div>
