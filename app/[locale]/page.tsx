            ...
            <div style={{ display: 'flex', gap: '8px', padding: '8px 12px 0' }}>
              <button
                ...
                style={{
                  ...
                  background: activeTab !== 'pizzaparty' ? '#F0EBE0' : 'transparent',
                  border: activeTab !== 'pizzaparty' ? '1.5px solid transparent' : '1.5px solid #6D6054',
                  borderRadius: activeTab !== 'pizzaparty' ? '10px 10px 0 0' : '10px',
                  marginBottom: activeTab !== 'pizzaparty' ? 0 : '6px',
                  alignSelf: activeTab !== 'pizzaparty' ? 'stretch' : 'center',
                  cursor: 'pointer',
