...
const {flourBehaviour,flourTypeLabel,flourTypeOption}=require('../app/components/FlourCatalogueBrowser.tsx');
...
test('equivalent catalogue types share one filter option',()=>{a.equal(flourTypeOption('Bread'),flourTypeOption('bread flour'));a.equal(flourTypeOption('Whole Wheat'),flourTypeOption('wholemeal'));a.equal(flourTypeOption('All Purpose'),flourTypeOption('all_purpose'));a.equal(flourTypeLabel(flourTypeOption('T65'),true),'T65');});
